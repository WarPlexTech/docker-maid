# Docker-maid [![Publish Docker image](https://github.com/WarPlexTech/docker-maid/actions/workflows/publish_image.yml/badge.svg)](https://github.com/WarPlexTech/docker-maid/actions/workflows/publish_image.yml) [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=WarPlexTech_docker-maid&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=WarPlexTech_docker-maid) [![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=WarPlexTech_docker-maid&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=WarPlexTech_docker-maid) [![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=WarPlexTech_docker-maid&metric=reliability_rating)](https://sonarcloud.io/summary/new_code?id=WarPlexTech_docker-maid) [![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=WarPlexTech_docker-maid&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=WarPlexTech_docker-maid) [![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=WarPlexTech_docker-maid&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=WarPlexTech_docker-maid)
